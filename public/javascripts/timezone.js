...
function get_tz_name() {
  ...
  if (-570 == so && -570 == wo) return 'Pacific/Marquesas';    /* unsupported */
  if (-540 == so && -600 == wo) return 'America/Adak';
  if (-540 == so && -540 == wo) return 'Pacific/Gambier';    /* unsupported */
  if (-480 == so && -540 == wo) return 'US/Alaska';
  if (-480 == so && -480 == wo) return 'Pacific/Pitcairn';    /* unsupported */
  if (-420 == so && -480 == wo) return 'US/Pacific';
  if (-420 == so && -420 == wo) return 'US/Arizona';
  if (-360 == so && -420 == wo) return 'US/Mountain';
  if (-360 == so && -360 == wo) return 'America/Guatemala';
  if (-360 == so && -300 == wo) return 'Pacific/Easter';    /* unsupported */
  ...
  if (60 == so && 120 == wo) return 'Africa/Windhoek';    /* unsupported */
  if (120 == so && 60 == wo) return 'Europe/Amsterdam';
  if (120 == so && 120 == wo) return 'Africa/Harare';
  if (180 == so && 120 == wo) return 'Europe/Athens';
  if (180 == so && 180 == wo) return 'Africa/Nairobi';
  if (240 == so && 180 == wo) return 'Europe/Moscow';
  if (240 == so && 240 == wo) return 'Asia/Dubai';    /* unsupported */
  ...
  if (660 == so && 660 == wo) return 'Pacific/Guadalcanal';    /* unsupported */
  if (690 == so && 690 == wo) return 'Pacific/Norfolk';    /* unsupported */
  if (720 == so && 660 == wo) return 'Asia/Magadan';
  if (720 == so && 720 == wo) return 'Pacific/Fiji';
  if (720 == so && 780 == wo) return 'Pacific/Auckland';
  if (765 == so && 825 == wo) return 'Pacific/Chatham';    /* unsupported */
  if (780 == so && 780 == wo) return 'Pacific/Enderbury';    /* unsupported */
  if (840 == so && 840 == wo) return 'Pacific/Kiritimati';    /* unsupported */
