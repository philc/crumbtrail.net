...
Drag.Base = new Class({
	...
	getOptions: function(){
		return {
			editor:Class.empty,/* added philc */
			handle: false,
			unit: 'px',
			onStart: Class.empty,
	...
	checkAndDrag: function(event){
		...
		if (distance > this.options.snap){
			...
			document.addEvent('mousemove', this.bound.move);
					if (this.editor){
						console.log("el has editor");
			//			this.editor.addEvent('mousemove',this.bound.move);
						global.addEvent('mousemove',this.bound.drag);
					}
			this.drag(event);
...
/*		console.log("in drag handler");*/
		this.out = false;
		/*console.log(event);
		console.log("before: ", event.page);
		console.log("relative to: " + event.event.relativeTo)*/
		if (event.event.relativeTo){
			var el = $(event.event.relativeTo);
			event.page.x+=el.getLeft();
			event.page.y+=el.getTop()
		}
/*		console.log("after: ", event.page);*/
		//return;
...
/*		if (event.out) this.out=true;	//philc
		this.out=true;*/
	...
	//				global.removeEvent('mousemove',this.bound.move); /*philc*/
	},
	...
	stop: function(){
		...
		if (this.editor){	/* philc */
			//this.editor.removeEvent('mousemove',this.bound.move);
			global.removeEvent('mousemove',this.bound.drag);
		}
